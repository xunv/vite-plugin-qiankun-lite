...
- [`b47c769`](https://github.com/xunv/vite-plugin-qiankun-lite/commit/b47c76955e8363269a9649fa163b63e03e4c51ae) Thanks [@xunv](https://github.com/xunv)! - fixCssLink now preserves the relevant attributes on the original `<link>` tags (crossorigin / media / integrity / referrerpolicy) and re-injects them in their original order, no longer hardcoding `crossOrigin=''`, to avoid breaking style loading when CORS is not configured or domains are consolidated.
